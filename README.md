...
[Demo](https://quantum-finance-14.preview.emergentagent.com) • [Documentación](#-documentación) • [API](#-api-endpoints)
...
**Configurar .env:**
```env
REACT_APP_BACKEND_URL=https://quantum-finance-14.preview.emergentagent.com
WDS_SOCKET_PORT=443
