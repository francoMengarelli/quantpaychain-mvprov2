...
[Demo](https://quantchain.preview.emergentagent.com) • [Documentación](#-documentación) • [API](#-api-endpoints)
...
**Configurar .env:**
```env
REACT_APP_BACKEND_URL=https://quantchain.preview.emergentagent.com
WDS_SOCKET_PORT=443
